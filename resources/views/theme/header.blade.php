    ...
    <div class="header-content-wrapper">
        <div class="search-bar w-search notification-list friend-requests">
            <div class="form-group with-button ">
                {{--<input class="form-control js-user-search" placeholder="{{ trans('word.Search here people or pages')}}" type="text">--}}

                <input id="input-search" class="form-control" placeholder="{{ trans('word.Search here people or pages')}}"  type="text"
                v-model="dosearch" v-on:Keyup="autoSearch" onfocus="show()">
            ...
            <div data-mcs-theme="dark" class="mCustomScrollbar search-user">

                        <ul class="notification-list friend-requests">
                            <li >
                                <div class="author-thumb"><img src="http://127.0.0.1:8000/img/avatar55-sm.jpg" alt="author"></div>
                                <div class="notification-event" >
                                    {{--<div v-if="result.length">--}}
                                        ...
                                        {{--</p>--}}
                                    {{--</div>--}}
                                    <a href="{{url('/profile/Mona')}}" class="h6 notification-friend">Mona</a>
                            ...
                            {{--<li >--}}
                                {{--<div class="author-thumb"><img src="http://127.0.0.1:8000/img/avatar56-sm.jpg" alt="author"></div>--}}
                                {{--<div class="notification-event" >--}}
                                    {{--<div v-if="result.length">--}}
                                        {{--<p v-for="result in results">--}}
                                            {{--@{{result.name}}--}}
                                        {{--</p>--}}
                                    {{--</div>--}}
                                    {{--<a href="{{url('/profile/Moazz')}}" class="h6 notification-friend">Moazz</a>--}}
        ...
        <a href="#" class="link-find-friend">{{ trans('word.Find Friends')}}</a>
            ...
            <div class="author-page author vcard inline-items more">
                <div class="author-thumb">
                    ...
                    <div class="more-dropdown more-with-triangle">
                        <div class="mCustomScrollbar" data-mcs-theme="dark">
                            <div class="ui-block-title ui-block-title-small">
                                <h6 class="title">{{ trans('word.Your Account')}}</h6>
                            </div>
                            ...
                            <ul class="account-settings">
                                <li>
                                    <a href={{url("/settings/".Auth::user()->id)}} >
                                        ...
                                        <span>{{ trans('word.Profile Settings')}}</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="CompanyPage">
                                        ...
                                        <span>{{ trans('word.Your Page')}}</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="GroupPage">
                                        ...
                                        <span>{{ trans('word.Your Group')}}</span>
                                    </a>
                                </li>
                                <li>
                            ...
                            <div class="ui-block-title ui-block-title-small">
                                <h6 class="title">{{ trans('word.Chat Settings')}}</h6>
                            </div>
                            ...
                            <ul class="chat-settings">
                                <li>
                                    <a href="#">
                                        <span class="icon-status online"></span>
                                        <span>{{ trans('word.Online')}}</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <span class="icon-status away"></span>
                                        <span>{{ trans('word.Away')}}</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <span class="icon-status disconected"></span>
                                        <span>{{ trans('word.Disconnected')}}</span>
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a href="#">
                                        ...
                                        <span>{{ trans('word.Invisible')}}</span>
                                    </a>
                                </li>
                            </ul>
                ...
                <a href={{url("/home")}} class="author-name fn">
                    ...
                    <span class="author-subtitle"> {{Auth::user()->profile->nickname }}</span>
                </a>
        ...
        {{--<div class="tab-pane " id="search" role="tabpanel">--}}
            ...
            {{--<form class="search-bar w-search notification-list friend-requests">--}}
                {{--<div class="form-group with-button">--}}
                    ...
                    {{--v-model="dosearch" v-on:Keyup="autoSearch">--}}
                {{--</div>--}}
            {{--</form>--}}
